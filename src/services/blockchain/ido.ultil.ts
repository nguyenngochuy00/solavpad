...
export const idoInfo = (idoAccount: IdoInfoType, currentTimestamp: number) => {
...
export const getPdaUser = (
	...
	const [idoPDAs, _] = PublicKey.findProgramAddressSync(
		[utils.bytes.utf8.encode('wl_ido_pad'), user.toBuffer(), idoPDA.toBuffer()],
		programId
	);
	return idoPDAs;
};
