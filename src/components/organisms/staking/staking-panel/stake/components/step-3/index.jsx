...
const SolStakingStakeStep3 = ({ stakeAmount, stakingSymbol, stakeLoadingPercent }) => {
    return <SolStakingStep
        ...
        description={<>
            ...
            <p>You will be asked to confirm that allow the smart contract to have access to <b>{stakeAmount} {stakingSymbol}</b> from your wallet.</p>
            <p><SolProgressBar percent={stakeLoadingPercent} /></p>
