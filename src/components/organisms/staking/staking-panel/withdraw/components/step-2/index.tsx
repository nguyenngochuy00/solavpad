		...
		<SolStakingStep
			...
			description={
				<>
					...
					<p>
						The withdrawal process has two steps. On the first transaction the
						withdrawal is initialized, and after 7 days passed a second
						withdrawal confirmation is required to finalize the process.{' '}
					</p>
					<p className="sol-staking-step-highlight">
						You will now be asked to confirm the withdrawal initialization by
						sending a web3 wallet transaction.
					</p>
				</>
			}
