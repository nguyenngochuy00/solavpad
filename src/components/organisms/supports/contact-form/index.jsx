...
const SolSupportsContactForm = ({ title, image, formData, onSubmit }) => {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="sol-support-contact-form-body">
                            <SolFormGroup
                                ...
                                leftIcon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" fillOpacity={0.2} xmlns="http://www.w3.org/2000/svg">
