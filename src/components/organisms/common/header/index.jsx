...
const SolHeader = ({ walletInfo, breadcrumbs, onClickConnectWallet, onClickWallet, onToggleSidebar, onDisconnectWallet }) => {
    return <div className="sol-header">
        ...
        <div className="sol-header-right">
            {!walletInfo ? <SolButton caption="Connect wallet" variant="primary" icon={
                <img src="/images/icons/wallet.svg" alt='' />
            } onClick={onClickConnectWallet} /> : <>
                <SolButton className="sol-btn-your-wallet" caption="0x23323...42323" variant="primary" icon={
                    <img src="/images/icons/wallet.svg" alt='' />
                } onClick={onClickWallet} />
                <SolButton className="sol-btn-disconnect" icon={
                    <img src="/images/icons/off.svg" alt='' />
                } caption="Disconnect" onClick={onDisconnectWallet} />
            </>
            }
        </div>
        <button type="button" className="sol-btn-toggle" onClick={onToggleSidebar}>
