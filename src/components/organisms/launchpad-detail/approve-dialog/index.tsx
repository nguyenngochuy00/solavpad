...
interface SolLaunchpadDetailApproveDialogProps {
	show?: boolean;
	projectName?: string;
	amountSymbol?: string;
	balance?: number;
...
const SolLaunchpadDetailApproveDialog = ({
	show,
	projectName,
	amountSymbol,
	balance = 0,
	onClose,
	onApprove
}: SolLaunchpadDetailApproveDialogProps) => {
	...
	return (
		<SolModal
			show={show}
			className="sol-launchpad-detail-approve-dialog"
